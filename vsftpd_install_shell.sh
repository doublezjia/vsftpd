...
# userdel vsftpd
# userdel www
# rm -rf /etc/vsftpd/vconf/
# rm -rf /home/wwwroot/web1/
# rm -rf /home/wwwroot/test1/

#新建用户vsftpd #
useradd vsftpd -d /home/wwwroot -s /bin/false
# useradd www -d /home/wwwroot -s /bin/false
...
touch /etc/vsftpd/vconf/web1
touch /etc/vsftpd/vconf/test1

mkdir -p /home/wwwroot/web1/http/
mkdir -p /home/wwwroot/test1/http/

echo -e "local_root=/home/wwwroot/web1/http/\nwrite_enable=YES\nanon_world_readable_only=NO\nanon_upload_enable=YES\nanon_mkdir_write_enable=YES\nanon_other_write_enable=YES" >> /etc/vsftpd/vconf/web1

echo -e "local_root=/home/wwwroot/test1/http/\nwrite_enable=YES\nanon_world_readable_only=NO\nanon_upload_enable=YES\nanon_mkdir_write_enable=YES\nanon_other_write_enable=YES" >> /etc/vsftpd/vconf/test1
